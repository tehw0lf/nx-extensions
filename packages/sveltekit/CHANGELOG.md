...
- **sveltekit:** upgrade versions and allow CLI overrides ([#1078](https://github.com/tehw0lf/nx-extensions/issues/1078))
- **sveltekit:** add skipPackageJson parameter ([4a6d4629](https://github.com/tehw0lf/nx-extensions/commit/4a6d4629))
...
- **sveltekit:** first change to move sveltekit to new Vite based build ([7b87549f](https://github.com/tehw0lf/nx-extensions/commit/7b87549f))
- **sveltekit:** add experimental executors ([6aa7d55c](https://github.com/tehw0lf/nx-extensions/commit/6aa7d55c))
- **sveltekit:** add component generator ([9bd7bbdd](https://github.com/tehw0lf/nx-extensions/commit/9bd7bbdd))
- **sveltekit:** add linting ([74a5d9a3](https://github.com/tehw0lf/nx-extensions/commit/74a5d9a3))
...
- **sveltekit:** export default for all generators ([61df76d4](https://github.com/tehw0lf/nx-extensions/commit/61df76d4))
...
- **sveltekit:** add $id to application generator ([7fb603e9](https://github.com/tehw0lf/nx-extensions/commit/7fb603e9))
- **sveltekit:** fix sveltekit config, kit{} isnt needed anymore ([08de1275](https://github.com/tehw0lf/nx-extensions/commit/08de1275))
...
- **sveltekit:** repair component generator ([53574755](https://github.com/tehw0lf/nx-extensions/commit/53574755))
- **sveltekit:** add missing dep ([716da35c](https://github.com/tehw0lf/nx-extensions/commit/716da35c))
- **svelte:** fix e2e test setup for vite ([7a2b5712](https://github.com/tehw0lf/nx-extensions/commit/7a2b5712))
